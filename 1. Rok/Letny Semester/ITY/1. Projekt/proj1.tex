...
\begin{quotation}
Čím více \emph{druhů}, \textbf{řezů}, {\tiny velikostí}, \textcolor{red}{barev}\linebreak písma a jiných \textsc{efektů} použijeme, tím \texttt{profesionálněji} bude {\Large \fontfamily{pzc}\selectfont dokument} vypadat.
